/**
 * Characterization tests for Studio Infographic API
 *
 * These tests capture the CURRENT BEHAVIOR of the infographic generation API.
...
describe('Studio Infographic API - Characterization Tests', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  describe('POST /api/studio/infographic', () => {
    it('should return 401 when user is not authenticated', async () => {
      ...
      const request = new NextRequest('http://localhost:3000/api/studio/infographic', {
        method: 'POST',
        body: JSON.stringify({
    ...
    it.skip('should create studio output record with type "infographic"', async () => {
      ...
      const mockOutput = {
        ...
        type: 'infographic',
        title: expect.stringContaining('인포그래픽'),
      };
